            ...
            <div class="ibox-content">
                <form action="{{url('admin/student/'.$siswa->id)}}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            <input value="{{old('name', $siswa->name)}}" required type="text" name="name" id="name" class="form-control">
                            @error('name')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-5">
                            <input value="{{old('nis', $siswa->nis)}}" required type="text" name="nis" id="nis" class="form-control">
                            @error('nis')
                                <li class="text-danger">
                                    <strong>{{ $message }}</strong>
                                </li>
                        ...
                        <div class="col-lg-4">
                            <input value="{{old('nisn', $siswa->nisn)}}" required type="text" name="nisn" id="nisn" class="form-control">
                            @error('nisn')
                                <li class="text-danger">
                                    <strong>{{ $message }}</strong>
                                </li>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-5">
                            <select required name="gender" id="gender" class="form-control">
                                ...
                                <option {{ old('gender', $siswa->gender) == 'l' ? "selected" : "" }} value="l">Laki-laki</option>
                                <option {{ old('gender', $siswa->gender) == 'p' ? "selected" : "" }} value="p">Perempuan</option>
                            </select>
                            @error('gender')
                                <li class="text-danger">
                                    <strong>{{ $message }}</strong>
                        ...
                        <div class="col-lg-4">
                            <div class="input-group m-b">
                                ...
                                <input value="{{old('phone', $siswa->phone)}}" required type="text" name="phone" id="phone" class="form-control">
                            </div>
                            @error('phone')
                                <li class="text-danger">
                                    <strong>{{ $message }}</strong>
