    ...
    <div class="col-lg-12">
        <div class="ibox">
            ...
            <div class="ibox-content">
                <form action="{{url('admin/master/home/'.$home->id.'/update')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group row">
                        <label for="Section" class="col-lg-2 col-form-label">Section</label>
                        <div class="col-lg-10">
                            <input disabled value="{{$home->section}}" type="text" required name="section" id="section" class="form-control">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            <select disabled name="type" id="type" class="form-control">
                                ...
                                <option {{ $home->type == 'wording' ? "selected" : "" }} value="wording">Wording</option>
                        ...
                        <div class="col-lg-10 item-content">
                            @if($home->type == 'image')
                                <label class="label-image">
                                    <img id="preview-image" class="m-xs img-md" src="{{asset('landing-page/image/'.$home->content)}}">
                                    <div class="btn-group-sm text-center">
                                        <label class="btn btn-primary" id="image-btn">
                                            <i class="fa fa-paperclip" id="image-btn"></i>
                                            <input value="{{old('content', $home->content)}}" type="file" onchange="changePreviewImage()" id="input-image" name="content" hidden accept=".png, .jpg, .jpeg"> 
                                        </label>
                                    </div>
                                </label>
                                <!-- @error('type')
                                ...
                                @enderror -->
                            @else
                                <input value="{{old('content',$home->content)}}" type="text" name="content" id="content" class="form-control">
                            @endif
                        </div>
                    </div>
